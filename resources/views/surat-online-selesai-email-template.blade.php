...
table, td { color: #000000; } @media (max-width: 480px) { #u_content_heading_1 .v-container-padding-padding { padding: 30px 10px 10px !important; } #u_content_heading_1 .v-font-size { font-size: 14px !important; } #u_content_heading_2 .v-container-padding-padding { padding: 20px 10px 10px 20px !important; } #u_content_heading_2 .v-font-size { font-size: 23px !important; } #u_content_image_2 .v-container-padding-padding { padding: 10px !important; } #u_content_image_2 .v-text-align { text-align: center !important; } #u_content_divider_1 .v-container-padding-padding { padding: 10px 20px !important; } #u_content_text_1 .v-container-padding-padding { padding: 20px 20px 30px !important; } }
    </style>
...
<table id="u_content_heading_1" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <h1 class="v-text-align v-font-size" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 17px; font-weight: 400;">P E M B E R I T A H U A N !</h1>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="{{ asset('/back/dist/email_template/surat_online/images/image-2.png') }}" alt="image" title="image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 530px;" width="530"/>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="right">
      ...
      <img align="right" border="0" src="{{ asset('/back/dist/email_template/surat_online/images/image-1.png') }}" alt="image" title="image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 28px;" width="28"/>
...
<table id="u_content_text_1" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align v-font-size" style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
    <p style="line-height: 140%;">Hi<span style="line-height: 19.6px;">, {{ $data['nama'] }}</span></p>
<p style="line-height: 140%;"> </p>
<p style="line-height: 140%;"><span style="line-height: 19.6px;">Surat permohonan dengan data berikut :<br /></span></p>
<p style="line-height: 140%;"> </p>
<p style="line-height: 140%;"><span style="line-height: 19.6px;">Tanggal Pengajuan : <strong>{{ $data['tanggal_pengajuan'] }}</strong></span><span style="line-height: 19.6px;"></span></p>
<p style="line-height: 140%;"><span style="line-height: 19.6px;">Jenis Surat : <strong>{{ $data['jenis_surat'] }}</strong></span><span style="line-height: 19.6px;"></span></p>
<p style="line-height: 140%;"><span style="line-height: 19.6px;">Nama : <strong>{{ $data['nama'] }}</strong></span><span style="line-height: 19.6px;"></span></p>
<p style="line-height: 140%;"><span style="line-height: 19.6px;">NIK : <strong>{{ $data['nik'] }}</strong></span></p>
<p style="line-height: 140%;"> </p>
<p style="line-height: 140%;"><span style="line-height: 19.6px;">Sudah kami terima. Silahkan ambil surat anda di kantor desa</span></p>
<p style="line-height: 140%;"> </p>
<p style="line-height: 140%;"><span style="line-height: 19.6px;">Terima Kasih</span></p>
<p style="line-height: 140%;"> </p>
  </div>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="{{ asset('/back/dist/email_template/surat_online/images/image-3.png') }}" alt="" title="" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 10%;max-width: 58px;" width="58"/>
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align v-font-size" style="font-size: 23px; font-weight: 700; color: #ffffff; line-height: 130%; text-align: center; word-wrap: break-word;">
    <p style="line-height: 130%;">Desa Toruakat</p>
  </div>
